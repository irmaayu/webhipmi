<div class="app-messaging-container">
    ...
    <li class="section">unread 
    <?php echo date('y-m-d H:i:s');?></li>
         <?php  
         ...
         if($value->pengirim_komentar==1){
          ...
          <li class="message">
            <a  href="<?php echo base_url('adpasar/detailchat/'.$value->pengirim_komentar); ?>"  aria-expanded="false" aria-controls="collapseMessaging">
  ...
  <div class="messaging">
        ...
        <div class="footer">
          <form action="<?php echo base_url('adpasar/proseschat/'.$id_chat); ?>" method="POST" accept-charset="utf-8" >
