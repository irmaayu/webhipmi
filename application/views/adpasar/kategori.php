			...
			<table class="table card-table">
	        	...
	        	<tbody>
	        		...
	        		<tr>
	        			...
	        			<td>
		              		<a href="<?php echo base_url('adpasar/editproduk/') ."/".$value->id_sub; ?>" title="Edit">
		              		...
		              		<a href="<?php echo base_url('adpasar/hapusproduk/') ."/".$value->id_sub; ?>" title="Hapus">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="card card-mini">
    	...
    	<div class="card-body no-padding table-responsive">
			<form action="<?php echo base_url('adpasar/proseskategori'); ?>" method="POST" accept-charset="utf-8">
				<table class="table card-table">
		        	<tbody>
		        		<tr>
		        			<td>
