  ...
  <div class="container-fluid">
    <div class="navbar-collapse collapse in">
      <ul class="nav navbar-nav navbar-mobile">
        ...
        <li class="logo">
          <a class="navbar-brand" href="<?php echo base_url('adpasar/soon'); ?>"><span class="highlight"><?php echo $this->session->userdata('adpasar_name'); ?></span></a>
        </li>
        <li>
          ...
          <div class="dropdown-menu">
            <ul>
              ...
              <li class="dropdown-footer">
                <a href="<?php echo base_url('adpasar/soon'); ?>">View All <i class="fa fa-angle-right" aria-hidden="true"></i></a>
              </li>
            </ul>
          </div>
        </li>
        <li class="dropdown notification warning">
          ...
          <div class="dropdown-menu">
            <ul>
              ...
              <li>
                <a href="<?php echo base_url('adpasar/soon'); ?>">
        ...
        <li class="dropdown profile">
          ...
          <div class="dropdown-menu">
            <div class="profile-info">
              <h4 class="username"><?php echo $this->session->userdata('adpasar_name'); ?></h4>
            </div>
            <ul class="action">
              <li>
                <a href="<?php echo base_url('adpasar/soon'); ?>">
              ...
              <li>
                <a href="<?php echo base_url('adpasar/chat'); ?>">
                  <span class="badge badge-danger pull-right">5</span>
                  My Inbox
                </a>
              </li>
              ...
              <li>
                <a href="<?php echo base_url('adpasar/logout'); ?>">
                  Logout
                </a>
              </li>
            </ul>
