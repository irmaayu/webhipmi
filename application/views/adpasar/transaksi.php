		            ...
		            ?>
		            			<tr>
					            	...
					            	<td><?php echo $value->nama_produk; ?></td>
					              	...
					              	<td>
					              		<a href="<?php echo base_url('adpasar/lunas_trx/') .$value->id; ?>" title="Edit">
					              		...
					              		<a href="<?php echo base_url('adpasar/pending_trx/') .$value->id; ?>" title="Lihat">
					              		...
					              		<a href="<?php echo base_url('adpasar/bl_trx/') .$value->id; ?>" title="Belum Lunas">
