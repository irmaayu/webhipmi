<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="card card-mini">
    	...
    	<div class="card-body no-padding table-responsive">
    		...
    		?>
	        <form action="<?php echo base_url('admin/editproduk'); ?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
	        	<table class="table card-table">
		        	<tbody>
		        		...
		        		<tr>
		        			...
		        			<td>
		        				<input type="file" name="foto" value="<?php echo $produk->foto_produk;?>" placeholder="">
		        			</td>
		        		</tr>
		        		<tr>
		        			<td>
