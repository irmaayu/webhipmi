					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-6">
							<div class="view-product2">
								<img src="<?php echo base_url();?>assets/images/produk/<?php echo $produk->foto_produk; ?>" alt="" />
								<h3>ZOOM</h3>
							</div>
							...
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									<div class="row">
										...
										<a href="<?php echo base_url('user/chat/'.$produk->id_produk); ?>" class="btn btn-fefault cart" style="background: grey;">	
										<i class="fa fa-comment"></i>
											<b>Chat dengan Penjual</b>
										</a>
									</div>
									</form>
								</span>
